...
public class OrmLearnApplication {
	...
	private static void testUpdateCountryName() {
		...
		Country country;
		try {
			countryService.updateCountry("AR", "ARARIA");
	...
	private static void testDeleteCountry() {
		LOGGER.info("Start");
		countryService.deleteCountry("AR");
		Country country;
		try {
			country = countryService.findCountryByCode("AR");
			LOGGER.debug("Country:{}", country);
	...
	private static void testSearchCountries() {
		LOGGER.info("Start");
		List<Country> countries = countryService.getSearchCountries("ou");
		Iterator it = countries.iterator();
		
		while(it.hasNext()) {
			LOGGER.debug("Country:{}",it.next());
		}
		LOGGER.info("End");
	}
	
	private static void testSearchCountriesByAlphabet() {
		LOGGER.info("Start");
		List<Country> countries = countryService.getSearchCountriesByAlphabet('Z');
		Iterator it = countries.iterator();
