...
{
$tid = $_SESSION['tid'];
$msg_to =  mysqli_real_escape_string($link, $_POST['msg_to']);
$subject = mysqli_real_escape_string($link, $_POST['subject']);
$message = mysqli_real_escape_string($link, $_POST['message']);

$insert = mysqli_query($link, "INSERT INTO message VALUES('','$tid','$name','$msg_to','$subject','$message',NOW())") or die (mysqli_error($link));
if(!$insert)
{
