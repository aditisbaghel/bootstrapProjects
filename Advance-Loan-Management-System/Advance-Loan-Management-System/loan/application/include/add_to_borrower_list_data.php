...
if($image == "")
{
	$insert = mysqli_query($link, "UPDATE borrowers SET fname='$fname', lname='$lname', email='$email', phone='$phone', addrs1='$addrs1', addrs2='$addrs2', city='$city', state='$state', zip='$zip', country='$country', comment='$comment', account='$account' WHERE id = '$id'") or die (mysqli_error($link));
	if(!$insert)
	{
	...
	elseif($imageFileType != "jpg" && $imageFileType != "png" && $imageFileType != "jpeg" && $imageFileType != "gif")
	{
		...
		$insert = mysqli_query($link, "UPDATE borrowers SET fname='$fname', lname='$lname', email='$email', phone='$phone', addrs1='$addrs1', addrs2='$addrs2', city='$city', state='$state', zip='$zip', country='$country', comment='$comment', account='$account', image='$location' WHERE id = '$id'") or die (mysqli_error($link));
		if(!$insert)
		{
			echo "<div class='alert alert-info'>Update Error.....Please try again later</div>";
		}
