Blood Bank in python .



OS :- Linux redhat Clan( redha,fedora,centos )
...
copy and paste all data of jeevndb.sql file and execute
...
copy *.py file to  /var/www/cgi-bin
...
copy jeevan dir to  /var/www/html/
